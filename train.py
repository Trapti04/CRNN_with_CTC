...
parser.add_argument('--batchSize', type=int, default=32, help='input batch size') #64
...
parser.add_argument('--nepoch', type=int, default=205, help='number of epochs to train for')
parser.add_argument('--cuda', action='store_true', help='enables cuda')
parser.add_argument('--ngpu', type=int, default=1, help='number of GPUs to use')
parser.add_argument('--pretrained', default='', help="path to pretrained model (to continue training)") # expr_backup/netCRNN_199_423.pth
parser.add_argument('--alphabet', type=str, default='0123456789,.:(%$!^&-/);<~|`>?+=_[]{}"\'@#*ABCDEFGHIJKLMNOPQRSTUVWXYZ\ ')
parser.add_argument('--expr_dir', default='expr', help='Where to store samples and models')
parser.add_argument('--displayInterval', type=int, default=500, help='Interval to be displayed') #500
parser.add_argument('--n_test_disp', type=int, default=10, help='Number of samples to display when test')
parser.add_argument('--valInterval', type=int, default=500, help='Interval to be displayed')#500
parser.add_argument('--saveInterval', type=int, default=500, help='Interval to be displayed')#500
